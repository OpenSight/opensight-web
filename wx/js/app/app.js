var projectApp = angular.module('projectApp', ['ui.router', 'oc.lazyLoad','angular-loading-bar', 'ngAnimate','ui.bootstrap','ngCookies','ngFileSaver']);
...
.config(function($controllerProvider, $compileProvider, $filterProvider, $stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $provide) {
        ...
        projectApp.asyncjs = function (js) {
